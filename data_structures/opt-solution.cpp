...
int Opt_Solution::concatenate_T(const Opt_Solution& other_solution, const distance_matrix distance_matrix) {
    int new_vertex_distance = calculate_new_vertex_distance(other_solution, distance_matrix);
...
int Opt_Solution::calculate_new_vertex_distance(const Opt_Solution& other_solution, distance_matrix distance_matrix) {
